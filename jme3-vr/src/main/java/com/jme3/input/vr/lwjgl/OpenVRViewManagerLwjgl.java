 ...
 */
public class OpenVRViewManagerLwjgl extends AbstractVRViewManager {

    private static final Logger logger = Logger.getLogger(OpenVRViewManagerLwjgl.class.getName());
     ...
     */
    public OpenVRViewManagerLwjgl(VREnvironment environment) {
