 ...
 */
public class OpenVrLwjgl implements VRAPI {
    
    private static final Logger logger = Logger.getLogger(OpenVrLwjgl.class.getName());
    ...
    private OpenVRInputLwjgl VRinput;
     ...
     */
    public OpenVrLwjgl(VREnvironment environment){
      this.environment = environment;
    }
    
    @Override
    public OpenVRInputLwjgl getVRinput() {
        return VRinput;
    }
    ...
    public Object getTrackedCamera(){
      throw new UnsupportedOperationException("Not yet implemented!");
    }
...
//        }
        ...
        if(hmdErrorStore.get(0) != VR.EVRInitError_VRInitError_None) {
            ...
            VRinput = new OpenVRInputLwjgl(environment);
            VRinput.init();
...
//            bounds.init(this);
    ...
    public void updatePose(){
        int result = VRCompositor.VRCompositor_WaitGetPoses(trackedDevicePose, trackedDevicePose);
