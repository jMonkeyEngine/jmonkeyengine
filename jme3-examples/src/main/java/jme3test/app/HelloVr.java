...
public class HelloVr extends SimpleApplication {
    ...
    private static final Logger logger = Logger.getLogger(HelloVr.class.getName());
    ...
    public HelloVr(AppState... initialStates) {
        super(initialStates);
...
//        settings.put(VRConstants.SETTING_GUI_OVERDRAW, true);         // show gui even if it is behind things.
        ...
        if (environment.isInitialized()) {
            ...
            SimpleApplication test = new HelloVr(vrAppState);
