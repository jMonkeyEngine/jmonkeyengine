 ...
 * @author codex
 */
public class HelloFrameGraph extends SimpleApplication {
    
    public static void main(String[] args) {
        HelloFrameGraph app = new HelloFrameGraph();
    ...
    public void simpleInitApp() {
        ...
        FrameGraph frameGraph = FrameGraphFactory.forward(assetManager);
