...
public class GLDebugES extends GLDebug implements GL, GLES_30, GLFbo, GLExt {
    ...
    public void glDrawBuffer(int mode) {
        ((GLES_30)gl).glDrawBuffer(mode);
        checkError();
    }

    public void glReadBuffer(int mode) {
        ((GLES_30)gl).glReadBuffer(mode);
        checkError();
    }
    ...
    public void glCompressedTexImage3D(int target, int level, int internalFormat, int width, int height, int depth,
        ...
        ((GLES_30)gl).glCompressedTexImage3D(target, level, internalFormat, width, height, depth, border, data);
        checkError();
    }
    ...
    public void glCompressedTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width,
        ...
        ((GLES_30)gl).glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, data);
        checkError();
    }

    public void glTexImage3D(int target, int level, int internalFormat, int width, int height, int depth, int border,
                                 int format, int type, ByteBuffer data) {
        ((GLES_30)gl).glTexImage3D(target, level, internalFormat, width, height, depth, border, format, type, data);
        checkError();
    }

    public void glTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height,
                                    int depth, int format, int type, ByteBuffer data) {
        ((GLES_30)gl).glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, data);
        checkError();
    }
