...
public class OldVertexBinding implements Iterable<VertexAttribute> {
    ...
    public OldVertexBinding(int binding, IntEnum<InputRate> rate) {
    ...
    public boolean equals(Object o) {
        ...
        OldVertexBinding that = (OldVertexBinding) o;
